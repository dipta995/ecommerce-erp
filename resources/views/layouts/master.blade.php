...
<body class="home-page home-01 ">
							...
							<ul>
                               <?php
                                    ...
                                    ?>
                                    	<li class="menu-item menu-item-has-children parent" >
                                            ...
                                            <ul class="submenu curency" >
                                                <li class="menu-item" >
                                                    <a title="Pound (GBP)" href="{{ route('profile.show') }}">Profile</a>
                                                </li>
                                                <li class="menu-item" >
                                    ...
                                    <?php
                                      ...
                                      echo '<li class="menu-item" ><a title="Register or Login" href="/login">Login</a></li>';
                                      echo '<li class="menu-item" ><a title="Register or Login" href="/register">Register</a></li>';
                                    }
                             ?>
					...
					<div class="mid-section main-info-area">
						...
						<div class="wrap-search center-section">
							<div class="wrap-search-form">
								<form action="{{ url('search/product') }}" id="form-search-top" method="get" name="form-search-top">
					...
					<div class="header-nav-section">
						<div class="container">
							<ul class="nav menu-nav clone-main-menu" id="mercado_haead_menu" data-menuname="Sale Info" >
                                ...
                                <li class="menu-item"><a href="{{ url('/shop/type/') }}/{{ $item->product_type }}" class="link-term">{{ $item->product_type }}</a><span class="nav-label hot-label">hot</span></li>
                                @endforeach
							</ul>
						</div>
					</div>
					...
					<div class="primary-nav-section">
						<div class="container">
							<ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
								...
								<li class="menu-item">
									<a href="{{ url('/order ') }}" class="link-term mercado-item-title">Order List</a>
								</li>
								<li class="menu-item">
									<a href="{{ url('/review') }}" class="link-term mercado-item-title">Review</a>
								</li>
							</ul>
						</div>
					</div>
	...
	<footer id="footer">
		<div class="wrap-footer-content footer-style-1">
			...
			<div style="background-color: #88880c;background-image: linear-gradient(to right, #88880c , #635D90);" class="wrap-function-info">
				<div class="container">
					<ul>
								...
								<div class="wrap-footer-item twin-item">
									...
									<div class="item-content">
										<div class="wrap-vertical-nav">
											<ul>
												<li class="menu-item"><a href="{{ url('user/profile') }}" class="link-term">My Account</a></li>
									...
									<div class="item-content">
										<div class="wrap-vertical-nav">
											<ul>
												...
												<li class="menu-item"><a href="{{ url('/order') }}" class="link-term">Cart</a></li>
												<li class="menu-item"><a href="{{ url('/order') }}" class="link-term">Order History</a></li>
											</ul>
										</div>
									</div>
								</div>
