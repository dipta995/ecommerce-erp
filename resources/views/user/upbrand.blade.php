            ...
            <div class="card">
              <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <a href="{{ url('/brand') }}" class="btn btn-success">Create New</a>
                    </div>
                </div>
                ...
                <form method="POST" action="{{ url('/up_brand') }}" class="forms-sample">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" value="{{ $brandbyid->brand_name }}" name="brand_name" class="form-control" id="exampleInputUsername2" placeholder="Username">
                        <input type="hidden" value="{{ $brandbyid->id }}" name="id" >
                    </div>
                  </div>
