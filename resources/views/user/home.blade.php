          ...
          <div class="card-body">
            ...
            <div class="aligner-wrapper">
              ...
              <div class="wrapper d-flex flex-column justify-content-center absolute absolute-center">
                <h2 class="text-center mb-0 font-weight-bold">Taka</h2>
                <small class="d-block text-center text-muted  font-weight-semibold mb-0">Total Stock price</small>
              </div>
            </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="d-sm-flex align-items-baseline report-summary-header">
                    <h5 class="font-weight-semibold">Today's Report Summary</h5> </button>
                  </div>
                </div>
              </div>
              <div class="row report-inner-cards-wrapper">
                <div class=" col-md -6 col-xl report-inner-card">
                  <div class="inner-card-text">
                    <span class="report-title">SELLING</span>

                    <h4>{{ $totalsellstoday }} Taka</h4>
                ...
                <div class="col-md-6 col-xl report-inner-card">
                  <div class="inner-card-text">
                    <span class="report-title">INVEST</span>
                    <h4>{{ $investamounttoday }} Taka</h4>
                ...
                <div class="col-md-6 col-xl report-inner-card">
                  <div class="inner-card-text">
                    <span class="report-title">Daily Cost</span>
                    <h4>{{ $dailytotalcosttoday }} </h4>
                ...
                <div class="col-md-6 col-xl report-inner-card">
                  <div class="inner-card-text">
                    <span class="report-title">Earn With vat</span>
                    <h4>
              {{ $totalearntoday-$totalduetoday }} TAKA</h4>
          ...
          <div class="card">
            <div class="card-body">
              <div class="row">
                <div class="col-md-12">
                  <div class="d-sm-flex align-items-baseline report-summary-header">
                    <h5 class="font-weight-semibold">Last Day Report Summary</h5> </button>
                  </div>
                </div>
              </div>
              <div class="row report-inner-cards-wrapper">
                ...
                <div class="col-md-6 col-xl report-inner-card">
                  <div class="inner-card-text">
                    <span class="report-title">INVEST</span>
                    <h4>{{ $investamountlastday }} Taka</h4>
                ...
                <div class="col-md-6 col-xl report-inner-card">
                  <div class="inner-card-text">
                    <span class="report-title">Earn With vat</span>
                    <h4>
              {{ $totalearnlastday-$totalduelastday }} TAKA</h4>
        ...
        <div class="card">
          <div class="card-body">
            <div class="row">
              <div class="col-md-12">
                <div class="d-sm-flex align-items-baseline report-summary-header">
                  <h5 class="font-weight-semibold">All Report Summary</h5> </button>
                </div>
              </div>
            </div>
            <div class="row report-inner-cards-wrapper">
              ...
              <div class="col-md-6 col-xl report-inner-card">
                <div class="inner-card-text">
                  <span class="report-title">Daily Cost /Due</span>
                  <h4>{{ $dailytotalcost }} /{{ $totaldue }}</h4>
          ...
          <div class="card">
            <div class="card-body">
              <div class="row">
                <div class="col-md-12">
                  <div class="d-sm-flex align-items-baseline report-summary-header">
                    <h5 class="font-weight-semibold">Last Month Report Summary</h5> </button>
                  </div>
                </div>
              </div>
              <div class="row report-inner-cards-wrapper">
                ...
                <div class="col-md-6 col-xl report-inner-card">
                  <div class="inner-card-text">
                    <span class="report-title">Daily Cost /Due</span>
                    <h4>{{ $dailytotalcostlast }} /{{ $totalduelast }}</h4>
                    {{-- <span class="report-count"> 5 Reports</span> --}}
                  </div>
                  <div class="inner-card-icon bg-warning">
                    <i class="icon-globe-alt"></i>
                ...
                <div class="col-md-6 col-xl report-inner-card">
                  <div class="inner-card-text">
                    <span class="report-title">Earn With vat</span>
                    <h4>
              {{ $totalearnlast-$totalduelast }} TAKA</h4>
                    {{-- <span class="report-count"> 9 Reports</span> --}}
                  </div>
                  <div class="inner-card-icon bg-primary">
                    <i class="icon-diamond"></i>
