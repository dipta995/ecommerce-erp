              ...
              <div class="card-body">
                ...
                <p class="card-description">Your Created Category</p>
                  {{-- MESSAGE --}}
                                ...
                                {{ $allcat->links('pagination.custom') }}
          ...
          <div class="col-md-6 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                ...
                <form method="POST" action="{{ url('/create_cat') }}" class="forms-sample">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" name="cat_name" class="form-control" id="exampleInputUsername2" placeholder="Category  Name">
                    </div>
                  </div>
