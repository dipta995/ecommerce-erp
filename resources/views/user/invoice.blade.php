 ...
 <head>
     ...
     <title>software maker invoice</title>
 </head>
 <body>
                    ...
                    {{--  <div class="row">
                        <div class="col-12">
                            <div class="text-center text-150">
                                ...
                                <span class="text-default-d3">softwaremaker.com</span>
                            </div>
                        </div>
                    </div>  --}}
                    <!-- .row -->
                    ...
                    <div class="row">
                        ...
                        <div class="text-95 col-sm-6 align-self-start d-sm-flex justify-content-end">
                            ...
                            <div class="text-grey-m2">
                                ...
                                <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span class="text-600 text-90">Status:</span> <span class="badge badge-warning badge-pill px-25">@php
...
@endforeach
                ...
                -->
                        ...
                        <div>
                            ...
                            {{-- @php
                                    if ( $customer->pay_status!=1) {
                                        echo ' <a href="#" class="btn btn-info btn-bold px-4 float-right mt-3 mt-lg-0">Pay Now</a>';
                                    }
                                @endphp --}}
